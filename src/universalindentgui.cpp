		...
		for (auto *const option : p_grp->options) {
			...
			if (option == &uncrustify::options::indent_with_tabs) {
...
#if defined(DEBUG) && !defined(WIN32)
				fprintf(pfile,
				        "ChoicesReadable=\"(%zu)Spaces only|(%zu)Indent with tabs, "
				        "align with spaces|(%zu)Indent and align with tabs\"\n",
				        optionNumber, optionNumber, optionNumber);
#else  // DEBUG
				fprintf(pfile, "ChoicesReadable=\"Spaces only|Indent with tabs, align "
				        "with spaces|Indent and align with tabs\"\n");
#endif // DEBUG
...
#if defined(DEBUG) && !defined(WIN32)
					fprintf(pfile,
					        "ChoicesReadable=\"(%zu)Ignore %s|(%zu)Add %s|(%zu)Remove "
					        "%s|(%zu)Force %s\"\n",
					        optionNumber, optionNameReadable, optionNumber,
					        optionNameReadable, optionNumber, optionNameReadable,
					        optionNumber, optionNameReadable);
#else  // DEBUG
					//                                0         1      2         3
					fprintf(pfile,
					        "ChoicesReadable=\"Ignore %s|Add %s|Remove %s|Force %s\"\n",
...
#if defined(DEBUG) && !defined(WIN32)
					fprintf(pfile,
					        "ChoicesReadable=\"(%zu)Newlines Unix|(%zu)Newlines "
					        "Win|(%zu)Newlines Mac|(%zu)Newlines Auto\"\n",
					        optionNumber, optionNumber, optionNumber, optionNumber);
#else  // DEBUG
					fprintf(pfile, "ChoicesReadable=\"Newlines Unix|Newlines "
					        "Win|Newlines Mac|Newlines Auto\"\n");
#endif // DEBUG
					fprintf(pfile, "ValueDefault=%s\n", option->str().c_str());
					break;
				...
				case uncrustify::OT_TOKENPOS:
...
#if defined(DEBUG) && !defined(WIN32)
					fprintf(pfile,
					        "ChoicesReadable=\"(%zu)Ignore %s|(%zu)Break %s|(%zu)Force "
					        "%s|(%zu)Lead %s|(%zu)Trail %s|",
					        optionNumber, optionNameReadable, optionNumber,
					        optionNameReadable, optionNumber, optionNameReadable,
					        optionNumber, optionNameReadable, optionNumber,
					        optionNameReadable);
					...
					fprintf(
						pfile,
						"ChoicesReadable=\"Ignore %s|Break %s|Force %s|Lead %s|Trail %s|",
						optionNameReadable, optionNameReadable, optionNameReadable,
...
#if defined(DEBUG) && !defined(WIN32)
					fprintf(pfile,
					        "(%zu)Join %s|(%zu)Lead Break %s|(%zu)Lead Force "
					        "%s|(%zu)Trail Break %s|(%zu)Trail Force %s\"\n",
					        optionNumber, optionNameReadable, optionNumber,
					        optionNameReadable, optionNumber, optionNameReadable,
					        optionNumber, optionNameReadable, optionNumber,
					        optionNameReadable);
#else  // DEBUG
					fprintf(pfile,
					        "Join %s|Lead Break %s|Lead Force %s|Trail Break %s|Trail "
					        "Force %s\"\n",
					        optionNameReadable, optionNameReadable, optionNameReadable,
					        optionNameReadable, optionNameReadable);
#endif // DEBUG
