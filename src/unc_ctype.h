...
static inline int unc_isspace(int ch) { return (isspace(unc_fix_ctype(ch))); }

//! check if a character is a printing character
static inline int unc_isprint(int ch) { return (isprint(unc_fix_ctype(ch))); }

//! check if a character is an alphabetic character (a letter).
static inline int unc_isalpha(int ch) { return (isalpha(unc_fix_ctype(ch))); }

//! check if a character is an alphanumeric character.
static inline int unc_isalnum(int ch) { return (isalnum(unc_fix_ctype(ch))); }

//! convert a character to upper case
static inline int unc_toupper(int ch) { return (toupper(unc_fix_ctype(ch))); }

//! convert a character to lower case
static inline int unc_tolower(int ch) { return (tolower(unc_fix_ctype(ch))); }

//! check if a character is a hexadecimal digit
static inline int unc_isxdigit(int ch) { return (isxdigit(unc_fix_ctype(ch))); }

//! check if a character is a decimal digit
static inline int unc_isdigit(int ch) { return (isdigit(unc_fix_ctype(ch))); }
